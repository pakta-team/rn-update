/**
 * [INPUT]: 依赖标准字符串/容器与 TypeScript 决策层所需的 JavaScript 值语义
 * [OUTPUT]: 对外提供 Value、Parse、Stringify、truthiness 与 primitive strict-equality 模型
 * [POS]: update_flow_core 的 JSON 防腐层，以最小实现复刻向量所依赖的 JS 对象和 undefined 行为
