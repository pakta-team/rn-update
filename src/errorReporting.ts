/**
 * [INPUT]: 依赖全局 ErrorUtils 错误处理链与调用方传入的 error/componentStack/extra 上下文
 * [OUTPUT]: 提供 serializeException 限长序列化与 installGlobalErrorHandler 链式全局错误捕获
 * [POS]: src 的错误上报基础层，为客户端遥测链提供可安全外发的异常快照
