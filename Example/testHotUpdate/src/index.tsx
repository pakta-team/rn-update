/**
 * [INPUT]: 依赖 rn-update 的 Pakta/useUpdate、update.json 的平台 appKey，以及相机、Paper、Sentry 和本地 TestConsole。
 * [OUTPUT]: 对外提供 App 根组件，展示更新检查、二维码解析、进度、版本信息与切换提示。
 * [POS]: testHotUpdate 的 JS 业务表面，统一承接手工验证动作并把状态投影给原生/端到端消费者。
