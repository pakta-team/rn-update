/**
 * [INPUT]: 依赖 rn-update 的 Pakta/UpdateProvider/useUpdate，以及 update.json 的 Harmony appKey。
 * [OUTPUT]: 对外提供 App 根组件，展示检查、下载、立即/延迟切换和当前版本状态。
 * [POS]: harmony_use_pakta 手工消费页面，验证 RN JS 状态如何穿过 RNOH/Harmony 宿主完成更新。
...
export default function Root() {
  return (
    <UpdateProvider client={paktaClient}>
      <App />
    </UpdateProvider>
  );
}
