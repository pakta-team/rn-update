/**
 * [INPUT]: 依赖各平台本地服务约定与制品命名事实
 * [OUTPUT]: 对外提供端点、appKey、hash、label、文件名和最终状态常量
 * [POS]: e2e 测试与脚本共享的纯配置契约，禁止产生 IO
...
export const LOCAL_UPDATE_APP_KEYS = {
  ...
  // The harmony e2e app lives in Example/harmony_use_pakta (RN 0.72, the
  // newest RN that RNOH supports); keep its copy of these constants in sync:
  // Example/harmony_use_pakta/e2e/localUpdateConfig.ts
