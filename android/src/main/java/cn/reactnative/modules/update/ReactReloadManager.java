/**
 * [INPUT]: 依赖 UpdateContext、ReactApplicationContext 与 ReactHost/ReactInstanceManager/ReactActivity 的跨版本反射能力
 * [OUTPUT]: 对内提供 restartApp，在切换可选版本后按新架构 Host、旧架构 InstanceManager、Activity 重建顺序重载
 * [POS]: Android React Native 生命周期兼容层，隔离框架版本差异，使 UpdateModuleImpl 不感知具体重载机制
