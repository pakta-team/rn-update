/**
 * [INPUT]: 依赖 Android PackageInstaller/Settings 权限体系、ReactApplicationContext 与 ErrorCodes
 * [OUTPUT]: 提供 ensureInstallPermission 权限确认与 APK 会话式安装（PendingIntent 回执驱动 Promise 归类）
 * [POS]: Android 的 APK 安装执行器，任何失败都以 reject 呈现而不允许逃逸崩溃
