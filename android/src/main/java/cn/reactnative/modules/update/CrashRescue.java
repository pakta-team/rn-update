/**
 * [INPUT]: 依赖默认 UncaughtExceptionHandler、进程/主线程时钟与 NativeCheckOrchestrator 的单轮救援能力
 * [OUTPUT]: 对内提供幂等 install，在启动早期崩溃窗口内按主/后台线程预算等待原生修复检查
 * [POS]: Android 冷启动救砖保险丝，只延迟进程死亡且始终把控制权交还既有崩溃处理链
