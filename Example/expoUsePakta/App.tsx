/**
 * [INPUT]: 依赖 rn-update 的 Pakta、PaktaProvider、usePakta，以及 update.json 的 Android appKey。
 * [OUTPUT]: 对外提供 HomeScreen 根组件，驱动更新检查、下载、切换与状态展示。
 * [POS]: expoUsePakta 的唯一业务页面，验证 Expo Modules 宿主与 SDK 更新状态之间的数据流。
...
import { Pakta, PaktaProvider, usePakta } from 'rn-update';
...
function Home() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.welcome}>欢迎使用Pakta热更新服务</Text>
...
export default function HomeScreen() {
  return (
    <PaktaProvider client={paktaClient}>
      <Home />
    </PaktaProvider>
  );
}
