/**
 * [INPUT]: 无 Android/OkHttp 依赖的纯字符串工具，服务 HTTP 路径逻辑
 * [OUTPUT]: 提供 isHttpsUrl、normalizeEndpointBase 与 Content-Range 续传头解析 parseContentRange
 * [POS]: Android 下载链路的 JVM 可测纯函数层，避开 DownloadTask 的 so/OkHttp 静态依赖
