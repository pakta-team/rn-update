/**
 * [INPUT]: 依赖 flow_json 值模型、调用方注入的设备身份/随机样本与 src/updateFlowCore.ts 参考语义
 * [OUTPUT]: 对外提供灰度、URL、请求体、响应解析、下载策略、激活策略和组合处理函数
 * [POS]: update_flow_core 的纯决策契约，平台编排器只执行其结果而不得重写策略
