/**
 * [INPUT]: 依赖 java.util.zip.ZipFile、规范化文件路径与受控解压目标目录
 * [OUTPUT]: 对外提供 SafeZipFile、受保护 entries 迭代及 unzipToPath/unzipToFile
 * [POS]: Android 归档安全边界，在 DownloadTask 和 BundledResourceCopier 读取任何条目前阻断 Zip Slip 路径穿越
...
public class SafeZipFile extends ZipFile {
    ...
    // decisions (the ".pakta-complete" install marker today). An archive
    ...
    static final String RESERVED_ENTRY_PREFIX = ".pakta-";
